...
class StateManager:
    ...
    def update_xml(self, new_xml: str) -> UpdateXMLResponse:
        try:
            # Guards
    ...
    def add_user(self, id: str, name: str) -> AddUserResponse:
        try:
            # Guards
            if id in self.users:
    ...
    def lock_element(self, element_id: str, user_id: str) -> LockUnlockElementResponse:
        try:
            # Guards
    ...
    def clear_locks_by_user(self, user_id: str) -> LockUnlockElementResponse:
